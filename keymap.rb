...
kbd.add_layer :lower, %i(
  ...
  KC_ESCAPE KC_GRAVE  KC_COMMA  KC_DOT    KC_SCOLON  KC_QUOTE   KC_SLASH  KC_BSLS   KC_LBRC   KC_RBRC
...
kbd.add_layer :raise, %i(
  ...
  KC_TAB    KC_TILD   KC_LABK   KC_RABK   KC_COLON   KC_LEFT    KC_DOWN   KC_UP     KC_RIGHT  KC_EQUAL
