...
kbd.define_mode_key :X_LCTL,    [ :KC_X,                               :KC_LCTL,                   550,             200 ]
kbd.define_mode_key :X_LSFT,    [ :KC_X,                               :KC_LSFT,                   550,             200 ]
kbd.define_mode_key :X_LALT,    [ :KC_X,                               :KC_LALT,                   550,             200 ]
kbd.define_mode_key :X_LGUI,    [ :KC_X,                               :KC_LGUI,                   550,             200 ]
kbd.define_mode_key :C_LALT,    [ :KC_C,                               :KC_LALT,                   550,             200 ]
...
kbd.define_mode_key :N_RALT,    [ :KC_N,                               :KC_RALT,                   550,             200 ]
...
kbd.define_mode_key :ENT_RAISE, [ :KC_ENTER,                           :raise,                     550,             200 ]
kbd.define_mode_key :ENT_RCTL,  [ :KC_ENTER,                           :KC_RCTL,                   550,             200 ]
kbd.define_mode_key :ENT_RSFT,  [ :KC_ENTER,                           :KC_RSFT,                   550,             200 ]
