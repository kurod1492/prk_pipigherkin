...
kbd.add_layer :lower, %i(
  ...
  UNDO      CUT       COPY      PASTE     LOWER      KC_LANG1   KC_RGUI   KC_RALT   KC_RCTL   KC_RSFT
)
kbd.add_layer :raise, %i(
  ...
  KC_LSFT   KC_LCTL   KC_LALT   KC_LGUI   ADJUST     RAISE      KC_GRAVE  KC_LABK   KC_RABK   KC_EQUAL
)
...
kbd.define_mode_key :X_LCTL,    [ :KC_X,                               :KC_LCTL,                   300,             200 ]
kbd.define_mode_key :X_LSFT,    [ :KC_X,                               :KC_LSFT,                   300,             200 ]
kbd.define_mode_key :X_LALT,    [ :KC_X,                               :KC_LALT,                   300,             200 ]
kbd.define_mode_key :X_LGUI,    [ :KC_X,                               :KC_LGUI,                   300,             200 ]
kbd.define_mode_key :C_LALT,    [ :KC_C,                               :KC_LALT,                   300,             200 ]
kbd.define_mode_key :C_LGUI,    [ :KC_C,                               :KC_LGUI,                   300,             200 ]
kbd.define_mode_key :V_LGUI,    [ :KC_V,                               :KC_LGUI,                   300,             200 ]
kbd.define_mode_key :V_LCTL,    [ :KC_V,                               :KC_LCTL,                   300,             200 ]
kbd.define_mode_key :A_LCTL,    [ :KC_A,                               :KC_LCTL,                   400,             200 ]
kbd.define_mode_key :B_RGUI,    [ :KC_B,                               :KC_RGUI,                   300,             200 ]
kbd.define_mode_key :B_RCTL,    [ :KC_B,                               :KC_RCTL,                   300,             200 ]
kbd.define_mode_key :B_RAISE,   [ :KC_B,                               :raise,                     300,             200 ]
kbd.define_mode_key :N_RALT,    [ :KC_N,                               :KC_RALT,                   400,             200 ]
kbd.define_mode_key :M_RCTL,    [ :KC_M,                               :KC_RCTL,                   400,             200 ]
kbd.define_mode_key :M_RGUI,    [ :KC_M,                               :KC_RGUI,                   400,             200 ]
kbd.define_mode_key :M_RSFT,    [ :KC_M,                               :KC_RSFT,                   400,             200 ]
kbd.define_mode_key :MINS_RSFT, [ :KC_MINUS,                           :KC_RSFT,                   200,             200 ]
kbd.define_mode_key :MINS_RCTL, [ :KC_MINUS,                           :KC_RCTL,                   200,             200 ]
kbd.define_mode_key :SLAS_RSFT, [ :KC_SLASH,                           :KC_RSFT,                   300,             200 ]
kbd.define_mode_key :COLN_RSFT, [ :KC_COLON,                           :KC_RSFT,                   300,             200 ]
kbd.define_mode_key :UNDS_RSFT, [ :KC_UNDS,                            :KC_RSFT,                   300,             200 ]
...
kbd.define_mode_key :BS_RAISE,  [ :KC_BSPACE,                          :raise,                     300,             200 ]
kbd.define_mode_key :BS_RCTL,   [ :KC_BSPACE,                          :KC_RCTL,                   300,             200 ]
kbd.define_mode_key :BS_RSFT,   [ :KC_BSPACE,                          :KC_RSFT,                   300,             200 ]
